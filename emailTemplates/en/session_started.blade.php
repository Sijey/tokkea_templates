...
<mjml>
    <mj-head>
        <title>Session has started</title>
                ...
                <mj-group>
                    <mj-column vertical-align="middle">
                        ...
                        <mj-text css-class="content-text">
                            The session you are subscribed to has begun
                            <br /><br />
                        ...
                        <mj-text css-class="content-text">
                            Please do not withdraw funds used during the trade session from the currency exchange
                            account until the end of the session
                        </mj-text>
